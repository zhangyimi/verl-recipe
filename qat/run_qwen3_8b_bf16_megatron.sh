...
# Sanity check that the verl_megatron_qat checkout + vllm012 image work end-to-end.
set -xeuo pipefail
...
# No QAT — pure BF16 baseline. Must explicitly disable qat (config yaml defaults qat.enable=True).
QAT=(
